            ...
            <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="is_preorder" value="1" {{ old('is_preorder', $product->is_preorder) ? 'checked' : '' }} class="rounded border-gray-300 dark:border-gray-700 text-purple-600 shadow-sm focus:ring-purple-500">
                                ...
                                <div>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="is_upcoming" value="1" {{ old('is_upcoming', $product->is_upcoming) ? 'checked' : '' }} class="rounded border-gray-300 dark:border-gray-700 text-purple-600 shadow-sm focus:ring-purple-500">
                                ...
                                <div>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="is_bookable" value="1" {{ old('is_bookable', $product->is_bookable) ? 'checked' : '' }} class="rounded border-gray-300 dark:border-gray-700 text-purple-600 shadow-sm focus:ring-purple-500">
                        ...
                        @if(true) {{-- variants available to every category --}}
                        ...
                        <div class="border-2 border-dashed border-amber-300 dark:border-amber-700 rounded-lg p-4 bg-amber-50 dark:bg-amber-900/20 space-y-6">
                            <h3 class="text-sm font-semibold text-amber-700 dark:text-amber-300 flex items-center gap-2">
                                <span>🎨</span> Product variants (colours / designs) — optional
                            </h3>
                                ...
                                <div class="variant-block mb-4 p-4 border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-900/50" data-variant-id="{{ $v->id }}">
                                    <div class="flex justify-between items-start gap-2 mb-2">
                                        <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-2">
                                            ...
                                            <input type="number" name="variants[{{ $v->id }}][quantity]" value="{{ old('variants.'.$v->id.'.quantity', $v->quantity) }}" min="0" placeholder="Stock" class="w-full border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm">
                                            <input type="text" name="variants[{{ $v->id }}][sku]" value="{{ old('variants.'.$v->id.'.sku', $v->sku) }}" placeholder="SKU (optional)" class="w-full border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm">
            ...
            if (newVariantsContainer && addVariantBtn) {
                addVariantBtn.addEventListener('click', () => {
                    ...
                    block.innerHTML = '<div class="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-2">' +
                        ...
                        '<input type="number" name="new_variants[' + newVariantIndex + '][quantity]" min="0" value="0" placeholder="Stock" class="w-full border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm">' +
                        '<input type="text" name="new_variants[' + newVariantIndex + '][sku]" placeholder="SKU (optional)" class="w-full border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm">' +
                        '<input type="hidden" name="new_variants[' + newVariantIndex + '][is_active]" value="1">' +
                        '</div>' +
