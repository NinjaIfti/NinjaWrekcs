                                    ...
                                    <td class="px-4 py-3 text-sm align-top">
                                        @if($entry->phone)
                                            <div class="flex items-center gap-2">
                                                ...
                                                <button type="button" onclick="CourierCheck.openModal('{{ $entry->phone }}')" class="px-2 py-0.5 text-xs bg-violet-500/10 hover:bg-violet-500/20 border border-violet-500/30 text-violet-600 dark:text-violet-400 rounded-full transition whitespace-nowrap">
                                                    Check Courier
                                                </button>
                                            </div>
                                        @else
