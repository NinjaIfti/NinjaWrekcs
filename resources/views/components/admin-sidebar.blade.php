    ...
    <div class="p-6">
        ...
        <nav class="space-y-2">
            ...
            <a href="{{ route('admin.analytics') }}" 
               @click="sidebarOpen = false"
               class="flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition {{ request()->routeIs('admin.analytics') ? 'bg-gray-100 dark:bg-gray-700 font-semibold' : '' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
