    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div class="relative">
                ...
                <!-- Floating Elements -->
                <div class="absolute -bottom-6 -left-6 w-48 md:w-72 h-48 md:h-72 bg-violet-500/20 rounded-full mix-blend-screen filter blur-3xl animate-float"></div>
                <div class="absolute -top-6 -right-6 w-48 md:w-72 h-48 md:h-72 bg-purple-500/20 rounded-full mix-blend-screen filter blur-3xl animate-float" style="animation-delay: 2s;"></div>
