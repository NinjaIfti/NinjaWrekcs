   ...
   Current Pricing is only for pre-order.
                ...
                <div class="flex flex-wrap items-center gap-6 pt-4">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <span>Valid till pre order ends</span>
                    </div>
                </div>
            </div>
            <div class="relative">
                <div class="glitch-image-wrapper">
                    <img src="https://images.unsplash.com/photo-1542751371-adc38448a05e?w=600" alt="Valorant Special Offer" class="rounded-2xl shadow-2xl border border-violet-500/30">
