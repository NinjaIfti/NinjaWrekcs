        ...
        <div class="grid md:grid-cols-4 gap-12 mb-12">
            <div class="space-y-4">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="https://wa.me/8801533133309" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-violet-900/50 rounded-lg flex items-center justify-center hover:bg-violet-600 transition-colors border border-violet-500/30" title="WhatsApp">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
