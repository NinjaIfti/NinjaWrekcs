        ...
        <div class="grid md:grid-cols-4 gap-12 mb-12">
            <div class="space-y-4">
                ...
                <div class="flex space-x-4">
                    <a href="#" class="w-10 h-10 bg-violet-900/50 rounded-lg flex items-center justify-center hover:bg-violet-600 transition-colors border border-violet-500/30">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="#" class="hover:text-violet-400 transition-colors">About Us</a></li>
