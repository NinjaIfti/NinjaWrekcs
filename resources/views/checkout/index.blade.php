                    ...
                    <div class="bg-black/50 backdrop-blur-xl rounded-2xl border border-violet-500/30 p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', auth()->user()->name ?? '') }}" required class="w-full px-4 py-3 bg-black/50 border border-violet-500/30 rounded-lg text-white focus:border-violet-500 focus:ring-violet-500/50">
                                @error('name')
                            ...
                            <div>
                                ...
                                <input type="text" name="phone" id="phone" value="{{ old('phone', auth()->user()->phone ?? '') }}" required class="w-full px-4 py-3 bg-black/50 border border-violet-500/30 rounded-lg text-white focus:border-violet-500 focus:ring-violet-500/50">
                                @error('phone')
                                    <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" value="{{ old('email') }}" class="w-full px-4 py-3 bg-black/50 border border-violet-500/30 rounded-lg text-white focus:border-violet-500 focus:ring-violet-500/50">
                                @error('email')
                                    <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="bg-black/50 backdrop-blur-xl rounded-2xl border border-violet-500/30 p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="transaction_number" id="transaction_number" value="{{ old('transaction_number') }}" required class="w-full px-4 py-3 bg-black/50 border border-violet-500/30 rounded-lg text-white focus:border-violet-500 focus:ring-violet-500/50" placeholder="Enter your transaction ID">
                            ...
                            <div>
                                ...
                                <input type="text" name="sending_number" id="sending_number" value="{{ old('sending_number') }}" required class="w-full px-4 py-3 bg-black/50 border border-violet-500/30 rounded-lg text-white focus:border-violet-500 focus:ring-violet-500/50" placeholder="Enter the number you sent from">
