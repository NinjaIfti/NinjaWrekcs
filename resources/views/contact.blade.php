...
<head>
    ...
    <title>Contact Us - NinjaWrekcs</title>
    ...
    <section class="pt-20 md:pt-32 pb-20 min-h-screen bg-gradient-to-b from-black via-violet-950/50 to-black">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-4xl md:text-5xl font-bold mb-8 text-center">
                <span class="glitch-text" data-text="Contact Us">Contact Us</span>
            </h1>

            <div class="bg-black/50 backdrop-blur-xl rounded-2xl border border-violet-500/30 p-8 md:p-12">
                <p class="text-lg text-gray-300 mb-8 text-center">
                    Have questions? We'd love to hear from you. Reach out to us through any of the following methods.
                </p>

                <div class="grid md:grid-cols-2 gap-6 mb-8">
                    <div class="bg-violet-900/20 rounded-xl border border-violet-500/30 p-6 text-center">
                    ...
                    <div class="bg-violet-900/20 rounded-xl border border-violet-500/30 p-6 text-center">
                        ...
                        <a href="https://wa.me/8801533133309" target="_blank" rel="noopener noreferrer" class="text-violet-400 hover:text-violet-300 transition">01533133309</a>
                    </div>
                </div>

                <div class="border-t border-violet-500/20 pt-8">
                    <h3 class="text-2xl font-bold mb-4 text-center">Follow Us</h3>
                    <div class="flex justify-center space-x-4">
                        <a href="https://www.facebook.com/ninjawrecks" target="_blank" rel="noopener noreferrer" class="w-12 h-12 bg-violet-900/50 rounded-lg flex items-center justify-center hover:bg-violet-600 transition-colors border border-violet-500/30" title="Facebook">
